...
namespace WorldServer
{
    class WorldServer
    {
        ...
        static void Main()
        {
            ...
            Log.Message(LogType.Normal, "Demarrage Arctium WorldServer...");
            ...
            if (WorldClass.world.Start(WorldConfig.BindIP, (int)WorldConfig.BindPort))
            {
                ...
                Log.Message(LogType.Normal, "WorldServer se connecte {0} port {1}.", WorldConfig.BindIP, WorldConfig.BindPort);
                Log.Message(LogType.Normal, "WorldServer est demarrer!");
            ...
            {
                Log.Message(LogType.Error, "Server n'a pas pu demarrer: ");
            }
